...
public class TwainSample
{
    public static async Task Run()
    {
        ...
        // 32-bit, but the better solution is to install the ApneScan.Sdk.Worker.Win32 Nuget package, which includes a
        // pre-compiled 32-bit ApneScan.Worker.exe. Then you only need to call ScanningContext.SetUpWin32Worker and you
