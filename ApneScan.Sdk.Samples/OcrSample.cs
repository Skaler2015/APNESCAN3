...
public class OcrSample
{
    ...
    {
        // Exporting PDFs with OCR requires the optional ApneScan.Tesseract.Binaries Nuget package to be installed.
        // Or, alternatively, you can use the system-installed Tesseract or provide a custom path to a Tesseract EXE.

        using var scanningContext = new ScanningContext(new GdiImageContext());

        // The ApneScan.Tesseract.Binaries package doesn't include all the actual language data (1GB+ for 100+ languages).
