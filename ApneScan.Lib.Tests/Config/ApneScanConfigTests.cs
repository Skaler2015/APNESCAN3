...
public class ApneScanConfigTests
{
    private readonly ApneScanConfig _config = ApneScanConfig.Stub(); 
    
    [Fact]
    public void StartsWithInternalDefaults()
    {
        Assert.Equal("en", _config.Get(c => c.Culture));
        Assert.Equal("ApneScan", _config.Get(c => c.PdfSettings.Metadata.Creator));
    }
    ...
    public void GetChildConfig()
    {
        ...
        Assert.Equal("ApneScan", metadata.Creator);
        ...
        Assert.Equal("ApneScan", pdfSettings.Metadata.Creator);
        ...
        Assert.Equal("ApneScan", commonConfig.PdfSettings.Metadata.Creator);
