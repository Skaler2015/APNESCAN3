...
#define AppLongName              "ApneScan - Not Another PDF Scanner"
#define AppCompany               "ApneScan Software"
#define AppCopyrightStartYear    "2009"
#define AppCopyrightEndYear      GetDateTimeString('yyyy','','')
#define AppCopyrightCompany      "ApneScan Contributors"
#define ExeName                  "ApneScan.exe"
...
AppPublisherURL=https://www.apnescan.com
AppSupportURL=https://www.apnescan.com/support
AppUpdatesURL=https://www.apnescan.com/download
...
OutputBaseFilename=apnescan-{#AppVersionName}-{#AppPlatform}
...
[Icons]
Name: "{group}\ApneScan"; Filename: "{app}\{#ExeName}"
Name: "{commondesktop}\ApneScan"; Filename: "{app}\{#ExeName}"; Tasks: desktopicon
...
Root: HKLM; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\AutoplayHandlers\Handlers\WIA_{{1c3a7177-f3a7-439e-be47-e304a185f932}"; ValueType: string; ValueName: "Action"; ValueData: "Scan with ApneScan"
...
Root: HKLM; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\AutoplayHandlers\Handlers\WIA_{{1c3a7177-f3a7-439e-be47-e304a185f932}"; ValueType: string; ValueName: "Provider"; ValueData: "ApneScan"

Root: HKLM; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\StillImage\Registered Applications"; Flags:uninsdeletevalue; ValueType: string; ValueName: "ApneScan"; ValueData: "{app}\{#ExeName}"
...
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\StillImage\Events\STIProxyEvent\{{1c3a7177-f3a7-439e-be47-e304a185f932}"; ValueType: string; ValueName: "Desc"; ValueData: "Scan with ApneScan"
...
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\StillImage\Events\STIProxyEvent\{{1c3a7177-f3a7-439e-be47-e304a185f932}"; ValueType: string; ValueName: "Name"; ValueData: "ApneScan"
