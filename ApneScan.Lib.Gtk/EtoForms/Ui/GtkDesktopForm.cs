...
public class GtkDesktopForm : DesktopForm
{
    ...
    protected override void UpdateProfilesToolbar()
    {
        ...
        for (int i = 0; i < missing; i++)
        {
            ...
            item.Clicked += (_, _) => _desktopScanController.ScanWithProfile((ScanProfile) item.Data["apnescan_profile"]!);
        ...
        for (int i = 0; i < profiles.Count; i++)
        {
            ...
            item.Data["apnescan_profile"] = profile;
