...
public class MacDesktopForm : DesktopForm
{
    ...
    {
        Title = UiStrings.ApneScan;
        if (OperatingSystem.IsMacOSVersionAtLeast(11))
        {
            this.ToNative().Subtitle = defaultProfile?.DisplayName ?? UiStrings.ApneScanFullName;
        }
    }
    ...
    protected override void CreateToolbarsAndMenus()
    {
        ...
        var toolbar = new NSToolbar("apnescan.desktop.toolbar");
