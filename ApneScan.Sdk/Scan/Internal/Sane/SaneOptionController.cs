...
using ApneScan.Scan.Internal.Sane.Native;

namespace ApneScan.Scan.Internal.Sane;

internal class SaneOptionController
{
    private readonly ISaneDevice _device;
    // TODO: Move exception handling + logging out if we split ApneScan.Sane off into a separate library
