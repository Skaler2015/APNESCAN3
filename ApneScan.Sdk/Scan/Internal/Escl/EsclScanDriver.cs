...
internal class EsclScanDriver : IScanDriver
{
        ...
        Action<IMemoryImage> callback)
    {
        ...
        try
        {
            ...
            bool hasProgressExtension = caps.ApneScanExtensions?.Contains("Progress") ?? false;
            bool hasErrorDetailsExtension = caps.ApneScanExtensions?.Contains("ErrorDetails") ?? false;
            bool hasShortTimeoutExtension = caps.ApneScanExtensions?.Contains("ShortTimeout") ?? false;
            bool hasAnyDpiExtension = caps.ApneScanExtensions?.Contains("AnyDpi") ?? false;
