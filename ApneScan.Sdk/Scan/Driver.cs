...
/// <br/>
/// See https://github.com/cyanfish/apnescan/tree/master/ApneScan.Sdk#drivers for more details.
/// </summary>
public enum Driver
{
    /// <summary>
    ...
    /// (e.g net10.0-macos) to use this driver type.
    /// </summary>
    Apple,

    /// <summary>
    /// Use a SANE driver (Linux and Mac). To use on Mac you'll also need to reference the ApneScan.Sane.Binaries package.
    /// </summary>
    Sane,
