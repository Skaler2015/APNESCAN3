...
internal abstract class WindowsSystemCompat : ISystemCompat
{
    ...
    public string? NativeWorkerAlias => WindowsEnvironment.IsRunningAsMsix ? "ApneScan_Alias.exe" : null;

    public string? WinX86WorkerAlias => WindowsEnvironment.IsRunningAsMsix ? "ApneScan.Worker_Alias.exe" : null;
