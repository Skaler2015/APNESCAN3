...
{
    public const string PIPE_NAME_FORMAT = "ApneScan.Worker.{0}";
    ...
    public static WorkerFactory CreateDefault()
    {
        ...
        string[] candidateWorkerPaths =
        {
            ...
            Path.Combine(AssemblyHelper.EntryFolder,
                @"..\..\..\..\..\ApneScan.App.Worker\bin\Debug\net10.0-windows\win-x86\ApneScan.Worker.exe"),
#endif
            Path.Combine(AssemblyHelper.EntryFolder, "ApneScan.Worker.exe"),
            Path.Combine(AssemblyHelper.EntryFolder, "lib", "ApneScan.Worker.exe")
        };
