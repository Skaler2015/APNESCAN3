...
/// <summary>
/// Entry point for the ApneScan.Worker.exe binary. You can use this to build your own custom binary instead of using the
/// one in the ApneScan.Sdk.Worker.Win32 nuget package.
/// </summary>
