...
public class TesseractLanguageManager
{
    ...
    [
        new(@"https://github.com/cyanfish/apnescan-components/releases/download/tesseract-4.0.0b4/{0}"),
        new(@"https://sourceforge.net/projects/apnescan/files/components/tesseract-4.0.0b4/{0}/download")
    ];
