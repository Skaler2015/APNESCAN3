...
public static class NLogConfig
{
    public static ILogger CreateLogger(Func<bool> enableDebugLogging)
    {
        ...
        return new NLogLoggerFactory().CreateLogger("ApneScan");
    }
    ...
    {
        get => Environment.GetEnvironmentVariable("ApneScan_DEBUG_LOGGING") == "1";
        set => Environment.SetEnvironmentVariable("ApneScan_DEBUG_LOGGING", value ? "1" : "0");
    }
