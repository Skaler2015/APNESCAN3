...
public class SharedDeviceManager : ISharedDeviceManager
{
    ...
    public SharedDeviceManager(ScanningContext scanningContext, ApneScanConfig config, string sharedDevicesConfigPath)
    {
    ...
    private bool TryStart()
    {
        lock (this)
        {
            ...
            // sharing lock (so multiple ApneScan instances don't try to share duplicates of the same devices)
