...
using static ApneScan.Remoting.ProcessCoordinatorService;

namespace ApneScan.Remoting;

/// <summary>
/// Manages communication and coordination between multiple ApneScan GUI processes. Specifically:
/// - Allows sending messages to other ApneScan processes via named pipes
...
/// same unit. Instead, this class handles the case where the user (or a system feature like StillImage) opens ApneScan
/// twice.
/// </summary>
public class ProcessCoordinator(string basePath, string pipeNameFormat)
{
    ...
    public static ProcessCoordinator CreateDefault() =>
        new(Paths.AppData, "ApneScan_PIPE_v2_{0}");
