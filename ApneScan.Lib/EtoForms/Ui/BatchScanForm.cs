...
public class BatchScanForm : EtoDialogBase
{
    ...
    private const string PATCH_CODE_INFO_URL = "https://www.apnescan.com/doc/batch-scan#patch-t";
    ...
    private readonly ApneScanConfig _transactionConfig;
    private bool _batchRunning;
    private CancellationTokenSource _cts = new();

    public BatchScanForm(ApneScanConfig config, DialogHelper dialogHelper, IProfileManager profileManager,
