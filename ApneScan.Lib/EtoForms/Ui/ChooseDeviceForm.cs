...
{
    private const string FLATPAK_MISSING_SCANNER_URL = "https://www.apnescan.com/doc/flatpak-missing-scanner";
    ...
    public ChooseDeviceForm(ApneScanConfig config, IIconProvider iconProvider,
