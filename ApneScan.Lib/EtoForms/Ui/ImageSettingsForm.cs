...
public class ImageSettingsForm : EtoDialogBase
{
    ...
    public ImageSettingsForm(ApneScanConfig config, DialogHelper dialogHelper, IIconProvider iconProvider) : base(config)
    {
    ...
    private void UpdateValues(ApneScanConfig config)
    {
