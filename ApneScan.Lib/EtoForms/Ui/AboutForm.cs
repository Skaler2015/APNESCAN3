...
{
    private const string ApneScan_HOMEPAGE = "https://www.apnescan.com";
    private const string ICONS_HOMEPAGE = "https://www.fatcow.com/free-icons";
    private const string DONATE_URL = "https://www.apnescan.com/donate?src=about";
    ...
    public AboutForm(ApneScanConfig config, UpdateChecker updateChecker, ScanningContext scanningContext)
        : base(config)
    {
