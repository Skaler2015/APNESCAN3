...
/// <summary>
/// Represents the full ApneScan configuration. Configuration sources are divided into several scopes:<br/>
...
///
/// A ApneScanConfig object can also represent a transaction, where the Run or User scopes contain uncommitted values.
/// </summary>
public class ApneScanConfig : ScopedConfig<CommonConfig>
{
    public static ApneScanConfig Stub() =>
        new(
    ...
    public ApneScanConfig(string appConfigPath, string userConfigPath)
    {
    ...
    public ApneScanConfig(ConfigScope<CommonConfig> appLocked, ConfigScope<CommonConfig> run,
    ...
    public ApneScanConfig WithTransaction(params TransactionConfigScope<CommonConfig>[] transactions)
    {
        var userScope = User;
        var runScope = Run;
        ...
        return new ApneScanConfig(AppLocked, runScope, userScope, AppDefault, InternalDefault);
    }

    public ApneScanConfig DefaultsOnly => new(AppLocked, new MemoryConfigScope<CommonConfig>(),
