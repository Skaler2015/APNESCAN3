...
using ApneScan.ImportExport.Email.Oauth;
using ApneScan.Scan;
...
internal class EmailProviderController
{
    ...
    public EmailProviderController(IFormFactory formFactory, ApneScanConfig config, ISystemEmailClients systemEmailClients,
