...
// TODO: N2Config vs files in ApneScanUserFolder?
public static class N2Config
{
    public static string ShareDir
    {
        get
        {
            ...
            {
                throw new Exception("Expected share-dir to be specified in ApneScan.Tools/n2-config.json");
            }
            return dir;
        }
    }
    ...
    public static string? WindowsIdentity => EnsureConfigFile().Value<string>("windows-identity") ?? "";
