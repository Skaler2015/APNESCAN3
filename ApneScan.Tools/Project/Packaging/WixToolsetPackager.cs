...
public static class WixToolsetPackager
{
    public static void PackageMsi(Func<PackageInfo> pkgInfoFunc, bool noSign)
    {
        ...
        Cli.Run("dotnet", "publish ApneScan.App.Worker -c Release /p:DebugType=None /p:DebugSymbols=false /p:DefineConstants=MSI");
        Cli.Run("dotnet", "publish ApneScan.App.WinForms -r win-x64 -c Release /p:DebugType=None /p:DebugSymbols=false /p:DefineConstants=MSI");
        Cli.Run("dotnet", "publish ApneScan.App.Console -r win-x64 -c Release /p:DebugType=None /p:DebugSymbols=false /p:DefineConstants=MSI");
