...
{
    private const string UPDATE_RELEASES_URL = "https://www.apnescan.com/hooks/update-releases";
    private const string ADD_FILE_SIG_URL = "https://www.apnescan.com/hooks/add-file-sig";

    public int Run(WebsiteUpdateOptions opts)
    {
        var key = File.ReadAllText(Path.Combine(Paths.ApneScanUserFolder, "website"));
