...
public class SaneOptsCommand : ICommand<SaneOptsOptions>
{
    ...
    {
        var dirPath = Path.Combine(Paths.SolutionRoot, "..", "apnescan-sane", "sources", "sane-backends", "po");
        ...
        var destPath =
            Path.Combine(Paths.SolutionRoot, "ApneScan.Sdk", "Scan", "Internal", "Sane", "SaneOptionTranslations.cs");
