...
public class PdfImportTests : ContextualTests
{
    ...
    public async Task ImportNonApneScanPdf(StorageConfig storageConfig)
    {
    ...
    [Theory]
    [ClassData(typeof(StorageAwareTestData))]
    public async Task ImportNonApneScanPdfFromStream(StorageConfig storageConfig)
    {
        storageConfig.Apply(this);
    ...
    [Theory]
    [ClassData(typeof(StorageAwareTestData))]
    public async Task ImportApneScanPdf(StorageConfig storageConfig)
    {
        storageConfig.Apply(this);
    ...
    [Theory]
    [ClassData(typeof(StorageAwareTestData))]
    public async Task ImportApneScanPdfFromStream(StorageConfig storageConfig)
    {
        storageConfig.Apply(this);
    ...
    [Theory]
    [ClassData(typeof(StorageAwareTestData))]
    public async Task ImportApneScanPdfWithUnicodePath(StorageConfig storageConfig)
    {
        storageConfig.Apply(this);
    ...
    [Theory]
    [ClassData(typeof(StorageAwareTestData))]
    public async Task ImportApneScanPngPdf(StorageConfig storageConfig)
    {
        storageConfig.Apply(this);
    ...
    [Theory]
    [ClassData(typeof(StorageAwareTestData))]
    public async Task ImportApneScanBlackWhitePdf(StorageConfig storageConfig)
    {
        storageConfig.Apply(this);
